...
class ScootMap extends Component {
    ...
    addSpinToMap = (map, lat, lng) => {
        ...
        const scooters = this.state.spin;
    ...
    addLyftToMap = (brand, color, map, lat, lng) => {
        var icon = new L.Icon({
        ...
        const scooters = this.state.lyft;
        const markerClusters = L.markerClusterGroup({
            iconCreateFunction: function(cluster) {
                var childCount = cluster.getChildCount();
                var c = ' size';
    ...
    addJumpToMap = (brand, color, map, lat, lng) => {
        var icon = new L.Icon({
            iconUrl: `https://cdn.rawgit.com/pointhi/leaflet-color-markers/master/img/marker-icon-2x-${color}.png`,
            shadowUrl: 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/0.7.7/images/marker-shadow.png',
            iconSize: [25, 41],
        ...
        const scooters = this.state.jump;
        const markerClusters = L.markerClusterGroup({
            iconCreateFunction: function(cluster) {
                var childCount = cluster.getChildCount();
                var c = ' size';
    ...
    addBirdToMap = (brand, color, map, lat, lng) => {
        var icon = new L.Icon({
            iconUrl: `https://cdn.rawgit.com/pointhi/leaflet-color-markers/master/img/marker-icon-2x-${color}.png`,
            shadowUrl: 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/0.7.7/images/marker-shadow.png',
            iconSize: [25, 41],
        ...
        const scooters = this.state.bird;
        const markerClusters = L.markerClusterGroup({
            iconCreateFunction: function(cluster) {
                var childCount = cluster.getChildCount();
                var c = ' size';
    ...
    addGotchaToMap = (brand, color, map, lat, lng) => {
        var icon = new L.Icon({
            iconUrl: `https://cdn.rawgit.com/pointhi/leaflet-color-markers/master/img/marker-icon-2x-${color}.png`,
            shadowUrl: 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/0.7.7/images/marker-shadow.png',
            iconSize: [25, 41],
        ...
        const scooters = this.state.gotcha;
        const markerClusters = L.markerClusterGroup({
            iconCreateFunction: function(cluster) {
                var childCount = cluster.getChildCount();
                var c = ' size';
    ...
    addLimeToMap = (brand, color, map, lat, lng) => {
        var icon = new L.Icon({
            iconUrl: `https://cdn.rawgit.com/pointhi/leaflet-color-markers/master/img/marker-icon-2x-${color}.png`,
            shadowUrl: 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/0.7.7/images/marker-shadow.png',
            iconSize: [25, 41],
        ...
        const scooters = this.state.lime;
        const markerClusters = L.markerClusterGroup({
            iconCreateFunction: function(cluster) {
                var childCount = cluster.getChildCount();
                var c = ' size';
